...
def splice_all_videos(data_dir_path="better_training", output_dir_path="raw_dataset", frame_splice=60):
    data_dir = Path(data_dir_path)
    spliced_videos = Path(output_dir_path)
    FRAME_SPLICE = frame_splice
